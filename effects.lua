...
--
-- Avoid modifying this list directly. Instead, use the addEffectToCheck and removeEffectToCheck functions from child scripts
effects_list = {"greater", "lesser", "unpain", "brain_unpain", "stun"}
