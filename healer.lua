...
addNewSpellAndAlias("shield_of_protection", "Shield of Protection", "sop", "/sop (.*)", aliasEnabledAndRegex, nil, 2, nil, "You form a barrier of repulsive magic around yourself\\.", "The shield of protection around you fades\\.")
