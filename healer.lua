...
AddAlias("luaAliasBrainUnpain", "^/bup(.*)$", "brain_unpain(trim('%1'))", alias_flag.Enabled + alias_flag.RegularExpression, "")
AddAlias("luaAliasMinorUnpain", "^/mup(.*)$", "minor_unpain(trim('%1'))", alias_flag.Enabled + alias_flag.RegularExpression, "")
AddAlias("luaAliasTrueUnpain", "^/tup(.*)$", "true_unpain(trim('%1'))", alias_flag.Enabled + alias_flag.RegularExpression, "")
addNewSpellAndAlias("heal", "Heal", "heal", "/h (.*)", aliasEnabledAndRegex, nil, 1, nil, nil, nil)
addNewSpellAndAlias("half_heal", "Half Heal", "half_heal", "/hh (.*)", aliasEnabledAndRegex, nil, 1, nil, nil, nil)